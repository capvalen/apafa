		...
		<div class="row">
			<section class="col-2 p-4">
				...
				<ul class="list-group list-group-flush ">
					...
					<li class="list-group-item list-group-item-action"><i class="bi bi-layers"></i> Deudas</li>
					<li class="list-group-item list-group-item-action"><i class="bi bi-cash"></i> Pagos</li>
